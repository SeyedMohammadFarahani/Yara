...
public class CNTextWatcher implements TextWatcher {
    ...
    /**
     * Create a credit card_fragment formatter with no max length and a padding specified in pixels
     *
     * @param paddingPx padding in pixels unit
     */
    public CNTextWatcher(int paddingPx) {
        setPaddingPx(paddingPx);
    }

    /**
     * Create a credit card_fragment formatter with no max length and a padding of 1 em (depends on text size).
     * <p>
     ...
     */
    public CNTextWatcher(@NonNull TextView textView) {
        setPaddingEm(textView, 1f);
    }

    /**
     * Create a credit card_fragment formatter with no max length and a padding specified in em (depends on text size).
     * <p>
     * The padding is not automatically updated if the text size or typeface are changed in the textview).
     *
     * @param textView  the widget you want to format
     ...
     */
    public CNTextWatcher(@NonNull TextView textView, float paddingEm) {
        setPaddingEm(textView, paddingEm);
    }

    /**
     * Create a credit card_fragment formatter with no max length and a padding specified in SP Unit (depends on the scale applied to text).
     *
     * @param context   any Context
     * @param paddingSp the padding in SP unit
     */
    public CNTextWatcher(@NonNull Context context, float paddingSp) {
    ...
    /**
     * Change maxLength of the credit card_fragment number, does not take effect until next text change
     *
...
/*        if (s.length() == 16)
            if (cardChecker(s.toString().trim())) {

              TashilatFragment.cardNum = s;
            }*/
    ...
    /**
     * Format the provided widget card_fragment number (useful if you want to reformat it after changing padding)
     *
     * @param textView the widget containing the credit card_fragment number
     */
